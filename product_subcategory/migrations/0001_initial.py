...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductSubcategory'
        db.create_table('product_subcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=128)),
        ))
        db.send_create_signal(u'product_subcategory', ['ProductSubcategory'])


    def backwards(self, orm):
        # Deleting model 'ProductSubcategory'
        db.delete_table('product_subcategory')
