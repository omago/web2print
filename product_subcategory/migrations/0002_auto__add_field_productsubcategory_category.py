...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSubcategory.category'
        db.add_column('product_subcategory', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['product_category.ProductCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductSubcategory.category'
        db.delete_column('product_subcategory', 'category_id')
