...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('printing_price', 'start_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=4))

        # Changing field 'PrintingPrice.start_price_per_sheet'
        db.alter_column('printing_price', 'start_price_per_sheet', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'PrintingPrice.start_price'
        db.alter_column('printing_price', 'start_price', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=11, decimal_places=4))

        # Changing field 'PrintingPrice.start_price_per_sheet'
        db.alter_column('printing_price', 'start_price_per_sheet', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=11, decimal_places=4))
    ...
    models = {
        ...
        u'printing_price.printingprice': {
            ...
            'printing_price_type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'start_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '11', 'decimal_places': '4', 'blank': 'True'}),
            'start_price_per_sheet': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '11', 'decimal_places': '4', 'blank': 'True'}),
