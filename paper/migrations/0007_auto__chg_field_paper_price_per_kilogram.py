...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('paper', 'price_per_kilogram', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Paper.price_per_kilogram'
        db.alter_column('paper', 'price_per_kilogram', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=11, decimal_places=4))
