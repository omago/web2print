...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Paper.price_per_kilogram_role'
        db.add_column('paper', 'price_per_kilogram_role',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=4, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Paper.price_per_kilogram_role'
        db.delete_column('paper', 'price_per_kilogram_role')
