...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductCategory.description'
        db.add_column('product_category', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductCategory.description'
        db.delete_column('product_category', 'description')
