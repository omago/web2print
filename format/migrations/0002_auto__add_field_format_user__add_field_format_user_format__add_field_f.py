...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Format.user'
        db.add_column('format', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Format.user_format'
        db.add_column('format', 'user_format',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Adding field 'Format.product_subcategory'
        db.add_column('format', 'product_subcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product_subcategory.ProductSubcategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Format.user'
        db.delete_column('format', 'user_id')

        # Deleting field 'Format.user_format'
        db.delete_column('format', 'user_format')

        # Deleting field 'Format.product_subcategory'
        db.delete_column('format', 'product_subcategory_id')
