...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.activation_code'
        db.add_column('user', 'activation_code',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.activation_code'
        db.delete_column('user', 'activation_code')


    models = {
        u'user.user': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'User', 'db_table': "'user'"},
            'activation_code': ('django.db.models.fields.CharField', [], {'max_length': '254', 'null': 'True'}),
