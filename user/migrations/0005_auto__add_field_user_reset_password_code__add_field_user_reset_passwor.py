...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.reset_password_code'
        db.add_column('user', 'reset_password_code',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.reset_password_code_expiration'
        db.add_column('user', 'reset_password_code_expiration',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.reset_password_code'
        db.delete_column('user', 'reset_password_code')

        # Deleting field 'User.reset_password_code_expiration'
        db.delete_column('user', 'reset_password_code_expiration')
