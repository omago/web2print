...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.start_price'
        db.add_column('user', 'start_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'User.click_price'
        db.add_column('user', 'click_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.start_price'
        db.delete_column('user', 'start_price')

        # Deleting field 'User.click_price'
        db.delete_column('user', 'click_price')
