...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field finish_type on 'Product'
        m2m_table_name = db.shorten_name('product_finish_type')
    ...
    def backwards(self, orm):
        # Removing M2M table for field finish_type on 'Product'
        db.delete_table(db.shorten_name('product_finish_type'))
