...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field finish_type on 'ProductFinish'
        m2m_table_name = db.shorten_name(u'product_productfinish_finish_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productfinish', models.ForeignKey(orm[u'product.productfinish'], null=False)),
            ('finishtype', models.ForeignKey(orm[u'finish_type.finishtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productfinish_id', 'finishtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field finish_type on 'ProductFinish'
        db.delete_table(db.shorten_name(u'product_productfinish_finish_type'))
