...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductPrinter.minimum'
        db.add_column(u'product_productprinter', 'minimum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductPrinter.minimum'
        db.delete_column(u'product_productprinter', 'minimum')
