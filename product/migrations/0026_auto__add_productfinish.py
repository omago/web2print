...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductFinish'
        db.create_table(u'product_productfinish', (
            ...
            ('turn_on', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'product', ['ProductFinish'])

        # Removing M2M table for field finish on 'Product'
        db.delete_table(db.shorten_name('product_finish'))


    def backwards(self, orm):
        # Deleting model 'ProductFinish'
        db.delete_table(u'product_productfinish')

        # Adding M2M table for field finish on 'Product'
        m2m_table_name = db.shorten_name('product_finish')
        ...
        db.create_unique(m2m_table_name, ['product_id', 'finish_id'])
    ...
    models = {
        ...
        u'product.product': {
            ...
            'finish': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['finish.Finish']", 'null': 'True', 'through': u"orm['product.ProductFinish']", 'blank': 'True'}),
