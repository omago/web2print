...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field finish_type on 'ProductCoverFinish'
        m2m_table_name = db.shorten_name(u'product_productcoverfinish_finish_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productcoverfinish', models.ForeignKey(orm[u'product.productcoverfinish'], null=False)),
            ('finishtype', models.ForeignKey(orm[u'finish_type.finishtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productcoverfinish_id', 'finishtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field finish_type on 'ProductCoverFinish'
        db.delete_table(db.shorten_name(u'product_productcoverfinish_finish_type'))
