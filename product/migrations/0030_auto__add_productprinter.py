...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductPrinter'
        db.create_table(u'product_productprinter', (
            ...
            ('printing_price_type', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'product', ['ProductPrinter'])

        # Removing M2M table for field printer on 'Product'
        db.delete_table(db.shorten_name('product_printer'))


    def backwards(self, orm):
        # Deleting model 'ProductPrinter'
        db.delete_table(u'product_productprinter')

        # Adding M2M table for field printer on 'Product'
        m2m_table_name = db.shorten_name('product_printer')
        ...
        db.create_unique(m2m_table_name, ['product_id', 'printer_id'])
