...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.basic_fields_order'
        db.delete_column('product', 'basic_fields_order')


    def backwards(self, orm):
        # Adding field 'Product.basic_fields_order'
        db.add_column('product', 'basic_fields_order',
