...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cover_printer on 'Product'
        m2m_table_name = db.shorten_name('product_cover_printer')
        ...
        # Adding M2M table for field insert_printer on 'Product'
        m2m_table_name = db.shorten_name('product_insert_printer')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'product.product'], null=False)),
            ('printer', models.ForeignKey(orm[u'printer.printer'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field cover_printer on 'Product'
        db.delete_table(db.shorten_name('product_cover_printer'))

        # Removing M2M table for field insert_printer on 'Product'
        db.delete_table(db.shorten_name('product_insert_printer'))
