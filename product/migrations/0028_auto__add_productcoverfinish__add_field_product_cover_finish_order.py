...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductCoverFinish'
        db.create_table(u'product_productcoverfinish', (
        ...
        db.send_create_signal(u'product', ['ProductCoverFinish'])

        # Adding field 'Product.cover_finish_order'
        db.add_column('product', 'cover_finish_order',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProductCoverFinish'
        db.delete_table(u'product_productcoverfinish')

        # Deleting field 'Product.cover_finish_order'
        db.delete_column('product', 'cover_finish_order')
