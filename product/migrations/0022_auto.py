...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field insert_press on 'Product'
        m2m_table_name = db.shorten_name('product_insert_press')
    ...
    def backwards(self, orm):
        # Removing M2M table for field insert_press on 'Product'
        db.delete_table(db.shorten_name('product_insert_press'))
