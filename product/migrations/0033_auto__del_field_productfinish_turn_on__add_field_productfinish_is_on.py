...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductFinish.turn_on'
        db.delete_column(u'product_productfinish', 'turn_on')

        # Adding field 'ProductFinish.is_on'
        db.add_column(u'product_productfinish', 'is_on',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductFinish.turn_on'
        db.add_column(u'product_productfinish', 'turn_on',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'ProductFinish.is_on'
        db.delete_column(u'product_productfinish', 'is_on')
