...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductCoverFinish.turn_on'
        db.delete_column(u'product_productcoverfinish', 'turn_on')

        # Adding field 'ProductCoverFinish.is_on'
        db.add_column(u'product_productcoverfinish', 'is_on',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductCoverFinish.turn_on'
        db.add_column(u'product_productcoverfinish', 'turn_on',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'ProductCoverFinish.is_on'
        db.delete_column(u'product_productcoverfinish', 'is_on')
