...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CartProduct.user_format'
        db.add_column('cart_product', 'user_format',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cart-product-custom-format', null=True, to=orm['user_format.UserFormat']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('cart_product', 'custom_format',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart-product-product-custom-format', null=True, to=orm['custom_format.CustomFormat'], blank=True),
                      keep_default=False)

        # Deleting field 'CartProduct.user_format'
        db.delete_column('cart_product', 'user_format_id')
    ...
    models = {
        ...
        u'user_format.userformat': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'UserFormat', 'db_table': "'custom_format'"},
            'height': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
