...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CartProduct.cover_paper'
        db.alter_column('cart_product', 'cover_paper_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['paper.Paper']))

    def backwards(self, orm):

        # Changing field 'CartProduct.cover_paper'
        db.alter_column('cart_product', 'cover_paper_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['press.Press']))
