...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartProduct.custom_format'
        db.add_column('cart_product', 'custom_format',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cart-product-product-custom-format', null=True, to=orm['custom_format.CustomFormat']),
                      keep_default=False)


        # Changing field 'CartProduct.format'
        db.alter_column('cart_product', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['format.Format']))

    def backwards(self, orm):
        # Deleting field 'CartProduct.custom_format'
        db.delete_column('cart_product', 'custom_format_id')


        # Changing field 'CartProduct.format'
        db.alter_column('cart_product', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['product_format.ProductFormat']))
    ...
    models = {
        ...
        u'cart_product.cartproduct': {
            ...
            'custom_format': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cart-product-product-custom-format'", 'null': 'True', 'to': u"orm['custom_format.CustomFormat']"}),
            ...
            'format': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cart-product-product-format'", 'null': 'True', 'to': u"orm['format.Format']"}),
        ...
        u'custom_format.customformat': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'CustomFormat', 'db_table': "'custom_format'"},
