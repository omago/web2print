...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field finish_type on 'CartProduct'
        m2m_table_name = db.shorten_name('cart_product_finish_type')
    ...
    def backwards(self, orm):
        # Removing M2M table for field finish_type on 'CartProduct'
        db.delete_table(db.shorten_name('cart_product_finish_type'))
