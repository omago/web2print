...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field finish on 'CartProduct'
        m2m_table_name = db.shorten_name('cart_product_finish')
    ...
    def backwards(self, orm):
        ...
        db.add_column('cart_product', 'finish',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart-product-finish', null=True, to=orm['finish.Finish'], blank=True),
                      keep_default=False)

        # Removing M2M table for field finish on 'CartProduct'
        db.delete_table(db.shorten_name('cart_product_finish'))
