...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartProduct.has_cover'
        db.add_column('cart_product', 'has_cover',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Adding field 'CartProduct.has_insert'
        db.add_column('cart_product', 'has_insert',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Adding field 'CartProduct.insert_press'
        db.add_column('cart_product', 'insert_press',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cart-product-insert-press', null=True, to=orm['press.Press']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartProduct.has_cover'
        db.delete_column('cart_product', 'has_cover')

        # Deleting field 'CartProduct.has_insert'
        db.delete_column('cart_product', 'has_insert')

        # Deleting field 'CartProduct.insert_press'
        db.delete_column('cart_product', 'insert_press_id')
    ...
    models = {
        ...
        u'product.product': {
            ...
            'insert_press': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'product-insert-press'", 'null': 'True', 'to': u"orm['press.Press']"}),
            ...
            'printer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['printer.Printer']", 'null': 'True', 'blank': 'True'}),
