...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartProduct.number_of_inserts'
        db.add_column('cart_product', 'number_of_inserts',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartProduct.number_of_inserts'
        db.delete_column('cart_product', 'number_of_inserts')
