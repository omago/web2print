...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CartProduct.insert_volume'
        db.add_column('cart_product', 'insert_volume',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CartProduct.insert_volume'
        db.delete_column('cart_product', 'insert_volume')
