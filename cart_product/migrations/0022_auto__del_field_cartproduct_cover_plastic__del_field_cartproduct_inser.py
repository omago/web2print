...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartProduct.cover_plastic'
        db.delete_column('cart_product', 'cover_plastic_id')

        # Deleting field 'CartProduct.insert_print'
        db.delete_column('cart_product', 'insert_print')

        # Adding field 'CartProduct.has_insert_print'
        db.add_column('cart_product', 'has_insert_print',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CartProduct.cover_plastic'
        db.add_column('cart_product', 'cover_plastic',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cart-product-cover-plastic', null=True, to=orm['plastic.Plastic'], blank=True),
                      keep_default=False)

        # Adding field 'CartProduct.insert_print'
        db.add_column('cart_product', 'insert_print',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'CartProduct.has_insert_print'
        db.delete_column('cart_product', 'has_insert_print')
    ...
    models = {
        ...
        u'product.product': {
            ...
            'finish_type': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'product_finish_type'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['finish_type.FinishType']"}),
